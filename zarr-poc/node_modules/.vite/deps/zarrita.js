...
function create_default_registry() {
  return (/* @__PURE__ */ new Map()).set("blosc", () => import("./blosc-7SHY257U.js").then((m) => m.default)).set("gzip", () => import("./gzip-XHZTT7OQ.js").then((m) => m.default)).set("lz4", () => import("./lz4-5D7MPZMZ.js").then((m) => m.default)).set("zlib", () => import("./zlib-OGAGMNLR.js").then((m) => m.default)).set("zstd", () => import("./zstd-BNTWEHJG.js").then((m) => m.default)).set("transpose", () => TransposeCodec).set("bytes", () => BytesCodec).set("crc32c", () => Crc32cCodec).set("vlen-utf8", () => VLenUTF8).set("json2", () => JsonCodec).set("bitround", () => BitroundCodec);
}
